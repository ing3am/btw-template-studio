...
export const DIAN_SAMPLE_DATA = {
  documento: {
    ...
    qrUrl:
      'https://api.qrserver.com/v1/create-qr-code/?size=160x160&data=https%3A%2F%2Fcatalogo-vpfe.dian.gov.co%2Fdocument%2Fsearchqr%3Fdocumentkey%3D8965881bf911dc57cea84f152750c1e996b7a46226269ecf7a004fb039699c13eee099c11cba2b7d8f9f85d96bdffd16',
  },
  emisor: {
